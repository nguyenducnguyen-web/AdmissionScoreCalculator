...
namespace DoanC_
{
    public partial class frmPT3_KSA_va_KSV : Form
    {
        private DuLieu dulieuueh;

        public frmPT3_KSA_va_KSV(DuLieu dulieuueh)
        {
            InitializeComponent();
        ...
        private void frmPT3_KSA_va_KSV_Load(object sender, EventArgs e)
        {

        }

        private void btnTTD_Click_1(object sender, EventArgs e)
        {
        ...
        private void frmPT3_KSA_va_KSV_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
