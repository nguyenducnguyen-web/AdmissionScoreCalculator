...
namespace DoanC_
{
    public partial class frmPT4_Asean_va_ISB : Form
    {
        private DuLieu dulieuueh;

        public frmPT4_Asean_va_ISB(DuLieu dulieuueh)
        {
            InitializeComponent();
        ...
        private void btnTTD_Click(object sender, EventArgs e)
        {
            ...
            double DTB10 = Convert.ToDouble(lbl10.Text);
            ...
            double DTB11 = Convert.ToDouble(lbl11.Text);
            ...
            double DTB12 = Convert.ToDouble(lbl12.Text);
        ...
        private void frmPT4_Asean_va_ISB_Load(object sender, EventArgs e)
        {

        }

        private void cbothm_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void frmPT4_Asean_va_ISB_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
