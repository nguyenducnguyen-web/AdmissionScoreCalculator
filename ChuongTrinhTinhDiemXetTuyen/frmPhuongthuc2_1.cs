...
namespace DoanC_
{
    public partial class frmPhuongthuc2_1 : Form

    {
        ...
        public frmPhuongthuc2_1(DuLieu dulieu)
        {
            InitializeComponent();
            InitializeData();
            this.dulieu = dulieu;
        ...
        private void cbohl10_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cbohl10.Text == "Học lực khá" ||  cbohl10.Text == "Học lực trung bình" )
            {
                MessageBox.Show("Bạn không đủ điều kiện để xét tuyển phương thức này. Vui lòng chọn phương thức xét tuyển khác.", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        }

        private void cbohl11_SelectedIndexChanged(object sender, EventArgs e)
        {
            
            
            if ( cbohl11.Text == "Học lực khá" ||  cbohl11.Text == "Học lực trung bình")
            {
                MessageBox.Show("Bạn không đủ điều kiện để xét tuyển phương thức này. Vui lòng chọn phương thức xét tuyển khác.", "Lỗi",
                MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        }

        private void cbohlhk1l12_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cbohlhk1l12.Text == "Học lực khá" || cbohlhk1l12.Text == "Học lực trung bình" )
            {
                MessageBox.Show("Bạn không đủ điều kiện để xét tuyển phương thức này. Vui lòng chọn phương thức xét tuyển khác.", "Lỗi",
                MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
        ...
        private void frmPhuongthuc2_1_Load(object sender, EventArgs e)
        {
        ...
        private void lblpt2_1_Click(object sender, EventArgs e)
        {
        ...
        private void frmPhuongthuc2_1_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
