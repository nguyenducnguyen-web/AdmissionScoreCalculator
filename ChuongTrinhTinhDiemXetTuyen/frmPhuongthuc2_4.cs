...
namespace DoanC_
{
    public partial class frmPhuongthuc2_4 : Form
    {
        private DuLieu dulieu;
        public frmPhuongthuc2_4(DuLieu dulieu)
        {
            InitializeComponent();
            InitializeData();
            this.dulieu = dulieu;
        ...
        private void frmPhuongthuc2_4_Load_1(object sender, EventArgs e)
        {
        ...
        {
            if (cbohl10.Text == "Học lực trung bình")
            {
        ...
        {
            if (cbohl11.Text == "Học lực trung bình")
            {
                MessageBox.Show("Bạn không đủ điều kiện để xét tuyển phương thức này. Vui lòng chọn phương thức xét tuyển khác.", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        {
            if (cbohlhk1l12.Text == "Học lực trung bình")
            {
                MessageBox.Show("Bạn không đủ điều kiện để xét tuyển phương thức này. Vui lòng chọn phương thức xét tuyển khác.", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void frmPhuongthuc2_4_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
